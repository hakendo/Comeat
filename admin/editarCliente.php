  ...
  <div class="container-slide fondo">
    <div class="container app-contenedor-dos">
      ...
      <div class="panel-header header">
        <p>
          <h3 class="app-font-style-titulo"> Editar cliente.</h3>
        </p>
      </div>
      <div class="panel-body fondo-dos">
        <div class="col-xs-12 ">
          <div class="panel-header ">Seleccione al cliente:</div>
          <div class="panel-body">
             <div class="col-md-12">
              <select id="cmbClientes" name="cmbClientes" class="form-control">
                ...
                $ejecutar_consulta = mysql_query($consulta) or die ("No se ha podido realizar la consulta en la BD");
                  ...
                  while ($row = mysql_fetch_array($ejecutar_consulta)) 
                  {
                         ...
                         echo '<option value="'.$row['ID_CLIENTE'].'">'.$row['CORREO_CLIENTE'].'</option>';        
                ...
                <input type="button" id="btnEditarCliente" class="btn btn-success" value="Seleccionar cliente" />
