    ...
    <body>
        ...
        <!-- FIN NAVEGADOR PLAN  -->
            ...
            <div class="panel-header header">
              <p>
                <h3 class="app-font-style-titulo"> Bienvenido <?php echo($nombre." ".$apellidoPaterno." ".$apellidoMaterno)  ?>.</h3>
              </p>
            </div>
            <div class="panel-body fondo-dos">
              ...
              <input type="button" id="btnEditar" name="btnEditar" class="btn btn-warning" value="Editar"> 
