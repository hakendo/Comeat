            ...
            <div class="container-slide fondo">
              <div class="container app-contenedor-dos">
                ...
                <div class="panel-header header">
                  <p>
                    <h3 class="app-font-style-titulo"> Usted est&aacute; agregando una nueva categor&iacute;a de men&uacute;.</h3>
                  </p>
                </div>
                  ...
                  <div class="col-xs-12 fondo-dos">
                    ...
                    <div class="col-xs-12 col-md-4">
                     ...
                     <form id="formulario" name="formulario" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" minlength="3" maxlength="30" class="form-control" id="categoriaMenu" name="categoriaMenu" placeholder="Ingrese la categor&iacute;a de men&uacute;" required >
                      </div>
                      ...
                      <input type="hidden" id="idCatMenu" name="idCatMenu" value="0" >
                    </div>
                    <!-- Columna 2 -->
                    <div class="col-xs-12 col-md-4">
                      <!-- Nombre Local  -->
                      <div class="form-group">
                        <label for="asunto_form">Orden por defecto:</label>
                        <input type="number" min="1" max="8" class="form-control" disabled="true" id="orden_categoria" name="orden_categoria" placeholder="Ingrese la categor&iacute;a de men&uacute;" required <?php echo "value='".$posicion."'";?>> <br>
                    
                      <div class="hidden" id="errorDiv" name="errorDiv">
                        <span class="label label-danger">Usted ya tiene el l&iacute;mite de categor&iacute;as</span>
                      </div>
                    ...
                    <div class="col-xs-12 col-md-4">
                     ...
                     <form id="formulario" name="formulario" enctype="multipart/form-data">
                        <br>
                      <div class="form-group">
                        <input type="button" id="btnAgregarCategoriaMenu" name="btnAgregarCategoriaMenu" class="btn btn-success" value="Agregar categor&iacute;a"> 
                      </div>  
                      </form> 
                    </div>
              </div>
