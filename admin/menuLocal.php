    ...
    <body>
        ...
        <!-- FIN NAVEGADOR PLAN  -->
            ...
            <div class="panel-header header">
              <p>
                <h3 class="app-font-style-titulo"> Seleccione las acciones que desea realizar para los men&uacute;s del local: <?php echo $row['NOMBRE_LOCAL']; ?>.</h3>
              </p>
            </div>
            ...
            <div class="alert alert-info " role="alert"><p><h4 class="app-font-style-titulo-dos"><span class="glyphicon glyphicon-info-sign "></span> La lista de "Menú", cambiar&aacute; dependiendo de la "Categor&iacute;a" seleccionada.</h4></p></div>
              ...
              <div class="col-xs-12 col-md-6 ">
                ...
                <br>
                <input type="button" id="btnAgregarCategoria" name="btnAgregarCategoria" class="btn btn-success" value="Agregar">
                <input type="button" id="btnEditarCategoria" name="btnEditarCategoria" class="btn btn-warning" value="Editar"> 
                <input type="button" id="btnEliminarCategoria" name="btnEliminarCategoria" class="btn btn-danger" value="Eliminar"><br><br>
                <input type="button" id="btnModificarOrdenCategoria" name="btnModificarOrdenCategoria" class="btn btn-primary" value="Modificar orden de categorias">
              ...
              <div class="col-xs-12 col-md-6 ">
              <h2>Men&uacute;:</h2>
              <select id="cmbMenu" name="cmbMenu" class="form-control"></select>
                <br>
              <input type="button" id="btnAgregarMenu" name="btnAgregarMenu" class="btn btn-success" value="Agregar">
              <input type="button" id="btnEditarMenu" name="btnEditarMenu" class="btn btn-warning" value="Editar"> 
              <input type="button" id="btnEliminarMenu" name="btnEliminarMenu" class="btn btn-danger" value="Eliminar">
              </div>
             </div>
