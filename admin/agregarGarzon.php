            ...
            <div class="container-slide fondo">
              <div class="container app-contenedor-dos">
                ...
                <div class="panel-header header">
                  <p>
                    <h3 class="app-font-style-titulo"> Usted est&aacute; agregando un nuevo Garz&oacute;n</h3>
                  </p>
                </div>
                    ...
                    <div class="col-xs-12 col-md-4">
                     ...
                     <form id="formulario" name="formulario" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" minlength="2" maxlength="50" class="form-control" id="nombreGarzon1" name="nombreGarzon1" placeholder="Ingrese el primer nombre del garz&oacute;n" required/>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" minlength="2" maxlength="50" class="form-control" id="nombreGarzon2" name="nombreGarzon2" placeholder="Ingrese el segundo nombre del garz&oacute;n" required/>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" minlength="3" maxlength="12" class="form-control" id="rutGarzon" name="rutGarzon" placeholder="Ingrese el RUT del garz&oacute;n" required/>
                 ...
                 <div class="col-xs-12 col-md-4">
                  ...
                  <!-- Apellido1 Garzon -->
                      <div class="form-group">
                        ...
                        <input type="text" minlength="2" maxlength="50" class="form-control" id="apellidoGarzon1" name="apellidoGarzon1" placeholder="Ingrese el primer apellido del garz&oacute;n" required/>
                   ...
                   <!-- Apellido2 Garzon -->
                      <div class="form-group">
                        ...
                        <input type="text" minlength="2" maxlength="50" class="form-control" id="apellidoGarzon2" name="apellidoGarzon2" placeholder="Ingrese el segundo apellido del garz&oacute;n" required/>
               ...
               <div class="col-xs-12 col-md-4">
                 ...
                 <!-- Correo Garzon -->
                      <div class="form-group">
                        ...
                        <input type="mail" minlength="6" maxlength="100" class="form-control" id="emailGarzon" name="emailGarzon" placeholder="Ingrese email de acceso" required/>
                   ...
                   <!-- Password Garzon -->
                      <div class="form-group">
                        ...
                        <input type="password" minlength="2" maxlength="50" class="form-control" id="passwordGarzon" name="passwordGarzon" placeholder="Ingrese el primer apellido del garz&oacute;n" required/>
                  ...
                  <div class="checkbox">
                  <label><input type="checkbox" id="esChef" name="esChef" value="1"> Es chef</label>
               ...
               <div class="form-group">
                <input type="button" id="btnAgregarGarzonEjecucion" name="btnAgregarGarzonEjecucion" class="btn btn-success" value="Agregar nuevo Garz&oacute;n"> 
              </div>  
