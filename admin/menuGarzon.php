    ...
    <body>
        ...
        <!-- FIN NAVEGADOR PLAN  -->
            ...
            <div class="panel-header header">
              <p>
                <h3 class="app-font-style-titulo"> Seleccione la acci&oacute;n que desea realizar a sus garzones del local: <?php echo $nombreLocal; ?> 
              </p>
            </div>
               ...
               while ($row = mysql_fetch_array($ejecutar_consulta)) 
                  {
                         ...
                         echo '<option value="'.$row['ID_GARZON'].'">'.$row['NOMBRE1_GARZON']." ".$row['APELLIDO1_GARZON'].'</option>';
                ...
                <div id="errorSelect" name="errorSelect" class="hidden">
                         <span class="label label-danger">Por favor seleccione a un garz&oacute;n</span>
                        </div>
                <br>
              <input type="button" id="btnAgregarGarzon" name="btnAgregarGarzon" class="btn btn-success" value="Agregar">
              <input type="button" id="btnModificarGarzon" name="btnModificarGarzon" class="btn btn-warning" value="Editar">
              <input type="button" id="btnEliminarGarzon" name="btnEliminarGarzon" class="btn btn-danger" value="Eliminar">
